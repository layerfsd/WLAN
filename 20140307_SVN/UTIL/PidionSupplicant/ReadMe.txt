================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : PidionSupplicant Project Overview
===============================================================================

The application wizard has created this PidionSupplicant application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your PidionSupplicant application.

PidionSupplicant.vcproj
...
PidionSupplicant.h
    ...
    project specific headers and declares the CPidionSupplicantApp application class.

PidionSupplicant.cpp
    This is the main application source file that contains the application
    class CPidionSupplicantApp.


PidionSupplicantppc.rc
...
res\PidionSupplicantppc.rc2
    This file contains resources that are not edited by Microsoft 
    Visual C++. You should place all resources not editable by
    the resource editor in this file.


res\PidionSupplicant.ico
...
PidionSupplicantDlg.h, PidionSupplicantDlg.cpp - the dialog
    These files contain your CPidionSupplicantDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named PidionSupplicant.pch and a precompiled types file named StdAfx.obj.
