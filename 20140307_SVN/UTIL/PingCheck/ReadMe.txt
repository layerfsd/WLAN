================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : PingCheck Project Overview
===============================================================================

The application wizard has created this PingCheck application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your PingCheck application.
...
PingCheck.h
    ...
    project specific headers and declares the CPingCheckApp application class.
...
PingCheckDlg.h, PingCheckDlg.cpp - the dialog
    These files contain your CPingCheckDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named PingCheck.pch and a precompiled types file named StdAfx.obj.
