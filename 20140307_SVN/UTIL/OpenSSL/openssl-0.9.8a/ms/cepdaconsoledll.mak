...
PLATFORM=VC-CE_PDA_CONSOLE
CC=$(CC)
CFLAG= /MC /O1i /W3 /GF /Gy /nologo -DUNICODE -D_UNICODE -DOPENSSL_SYSNAME_WINCE -DWIN32_LEAN_AND_MEAN -DL_ENDIAN -DDSO_WIN32 -DNO_CHMOD -DWCE_ON_DEVICE_CONSOLE -DBUFSIZ=512 -I$(WCE_LITE_COMPAT)/include -I$(PORTSDK_DIR)/include -D_WIN32_WCE=502 -DUNDER_CE=502 -DWCE_PLATFORM_VC-CE -DARM -D_ARM_ -DARMV4I -QRarch4T -QRinterwork-return /Fdout32dll_$(TARGETCPU)_pda_console -DOPENSSL_NO_RC5 -DOPENSSL_NO_MDC2 -DOPENSSL_NO_KRB5    
APP_CFLAG=
...
LINK=link
LFLAGS= /nologo /opt:ref /LIBPATH:$(WCE_LITE_COMPAT)\lib /subsystem:windowsce,5.02 /LIBPATH:$(PORTSDK_DIR)/lib/ARM /machine:THUMB  /entry:mainCRTStartup
RSC=rc
...
OUT_D=out32dll_$(TARGETCPU)_pda_console
# The output directory for all the temporary muck
TMP_D=tmp32dll_$(TARGETCPU)_pda_console
...
MKDIR=-mkdir
MKLIB=lib
MLFLAGS=  /nologo /opt:ref /LIBPATH:$(WCE_LITE_COMPAT)\lib /subsystem:windowsce,5.02 /LIBPATH:$(PORTSDK_DIR)/lib/ARM /machine:THUMB  /dll
ASM=ml /Cp /coff /c /Cx
...
CRYPTOOBJ=$(OBJ_D)\cryptlib.obj \
	...
	$(OBJ_D)\pcy_lib.obj $(OBJ_D)\conf_err.obj $(OBJ_D)\conf_lib.obj \
...
$(OBJ_D)\cversion.obj: $(SRC_D)\crypto\cversion.c
	$(CC) /Fo$(OBJ_D)\cversion.obj  $(SHLIB_CFLAGS) -DOPENSSL_BUILD_SHLIBCRYPTO -DMK1MF_BUILD -DMK1MF_PLATFORM_VC_CE_PDA_CONSOLE -c $(SRC_D)\crypto\cversion.c
...
$(O_SSL): $(SSLOBJ)
  ...
  $(SHLIB_EX_OBJ) $(SSLOBJ)  $(L_CRYPTO) portlib.lib wce_lite_compat.lib ws2.lib
<<

$(O_CRYPTO): $(CRYPTOOBJ)
	$(LINK) $(MLFLAGS) /out:$(O_CRYPTO) /def:ms/LIBEAY32.def @<<
  $(SHLIB_EX_OBJ) $(CRYPTOOBJ)  portlib.lib wce_lite_compat.lib ws2.lib
<<
