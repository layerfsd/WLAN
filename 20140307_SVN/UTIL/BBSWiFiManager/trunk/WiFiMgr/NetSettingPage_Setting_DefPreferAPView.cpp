...
void CNetSettingPage_Setting_DefPreferAPView::OnInitialUpdate()
{
	...
	// Hidden
	if(m_defPrefNetInfo.bHidden)
	{
		m_bHidden = TRUE;
		CheckDlgButton(IDC_CHECK_HIDDEN, BST_CHECKED);
	}
	else
	{
		m_bHidden = FALSE;
		CheckDlgButton(IDC_CHECK_HIDDEN, BST_UNCHECKED);
	}
...
void CNetSettingPage_Setting_DefPreferAPView::OnApply()
{
	...
	TCHAR tszIPAddr[18] = L"";
	TCHAR tszSubnetMask[18] = L"";
	TCHAR tszGateWay[18] = L"";
	TCHAR tszDnsAddr[18] = L"";
	TCHAR tszSSID[255] = L"";
	...
	m_defPrefNetInfo.bHidden = m_bHidden;
