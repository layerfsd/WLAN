...
// This is an OR combination with the dwType field used
// to set trust bit on the notification record; only 
// trusted applications can set this bit.
#define CNT_TRUST 0x80000000
