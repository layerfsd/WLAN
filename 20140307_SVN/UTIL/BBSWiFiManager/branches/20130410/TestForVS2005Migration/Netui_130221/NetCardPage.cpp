...
IMPLEMENT_DYNAMIC(CNetCardPage, CPropertyPage)

CNetCardPage::CNetCardPage()
	: CPropertyPage(CNetCardPage::IDD)
{
...
void CNetCardPage::DoDataExchange(CDataExchange* pDX)
{
	CPropertyPage::DoDataExchange(pDX);
}


BEGIN_MESSAGE_MAP(CNetCardPage, CPropertyPage)
END_MESSAGE_MAP()


// CNetCardPage 메시지 처리기입니다.

LRESULT CNetCardPage::WindowProc(UINT message, WPARAM wParam, LPARAM lParam)
{
...
BOOL CNetCardPage::OnInitDialog()
{
...
BOOL CNetCardPage::OnNotify(WPARAM wParam, LPARAM lParam, LRESULT* pResult)
{
	// TODO: 여기에 특수화된 코드를 추가 및/또는 기본 클래스를 호출합니다.
...
BOOL CNetCardPage::OnCommand(WPARAM wParam, LPARAM lParam)
{
	// TODO: 여기에 특수화된 코드를 추가 및/또는 기본 클래스를 호출합니다.
