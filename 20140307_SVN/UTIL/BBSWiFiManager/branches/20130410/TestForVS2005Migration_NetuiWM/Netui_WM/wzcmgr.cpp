...
{
	BBS_DEF_PREF_NETWORK_INFO defPrefNetInfo;
	...
	case WZC_STARTED:
		...
		RETAILMSG(1, (TEXT("NETUI: Started service for '%s'\r\n"), ple->ptcAdapterName));
		...
		if(defPrefNetInfo.bEnable == TRUE)
		{
			...
			if(wzcConfig.Privacy == Ndis802_11WEPEnabled)
			{
				...
				else
				{
					...
					{
						NKDbgPrintfW(L"[NETUI] invalid key index \r\n");
						goto ConnectError;
					}
					...
					if(defPrefNetInfo.bHexKey == TRUE)
					{
						...
						{
							NKDbgPrintfW(L"[NETUI] invalid key length (s/b 10 or 26 (hex) \r\n");
							break;
						}
						...
						for (UINT cx = 0, abyte = 0 ; cx < dwkeyLength ; ++cx)
						{
							...
							case L'D': case L'E': case L'F':
								...
								break;
							default:
								NKDbgPrintfW(L"[NETUI] invalid HEX WEP key \r\n");
								goto ConnectError;
							}
							if ((cx & 1) == 0)
							{
					...
					else
					{
						...
						{
							NKDbgPrintfW(L"[NETUI] invalid key length (s/b 5 or 13 (ascii) \r\n");
							break;
						}
			...
			else if( (wzcConfig.Privacy == Ndis802_11Encryption2Enabled) || (wzcConfig.Privacy == Ndis802_11Encryption3Enabled) )
			{
				...
				else
				{
					...
					{
						NKDbgPrintfW(L"[NETUI] WPA-PSK/TKIP key should be 8-63 char long string \r\n");
						goto ConnectError;
					}
...
ConnectError:
    ...
    case WZC_ASSOCIATING:
        ...
        RETAILMSG(1, (TEXT("Wi-Fi: '%s' is attempting to connect to '%S'...\r\n"), ple->ptcAdapterName, ple->pucSSID));
    ...
    case WZC_AUTHENTICATING:
        ...
        RETAILMSG(1, (TEXT("Wi-Fi: '%s' is attempting to authenticate on '%S'...\r\n"), ple->ptcAdapterName, ple->pucSSID));
        break;
    ...
    case WZC_ASSOCIATED_REQUIRES_8021X:
        ...
        RETAILMSG(1, (TEXT("Wi-Fi: '%s' has associated successfully with '%S'\r\n"), ple->ptcAdapterName, ple->pucSSID));
        break;
    ...
    case WZC_AUTHENTICATED:
        ...
        RETAILMSG(1, (TEXT("Wi-Fi: '%s' has authenticated successfully on '%S'\r\n"), ple->ptcAdapterName, ple->pucSSID));
