...
HRESULT SetCallbackRegistration(BOOL fRegistration, PWLAN_INFO psInfo) 
{
	...
	RETAILMSG(1, (TEXT("[NETUI] SetCallbackRegistration(%d), (%d)  \r\n"), fRegistration, psInfo ));
    ...
    {
		RETAILMSG(1, (TEXT("[NETUI] SetCallbackRegistration1  \r\n") ));
    ...
    {
		RETAILMSG(1, (TEXT("[NETUI] SetCallbackRegistration2  \r\n") ));
    ...
    {
		RETAILMSG(1, (TEXT("[NETUI] SetCallbackRegistration3  \r\n") ));
        hr = S_FALSE;
    }
