// Netui_WM.cpp : 해당 DLL의 초기화 루틴을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CNetui_WMApp, CWinApp)
END_MESSAGE_MAP()


// CNetui_WMApp 생성

CNetui_WMApp::CNetui_WMApp()
{
...
BOOL CNetui_WMApp::InitInstance()
{
