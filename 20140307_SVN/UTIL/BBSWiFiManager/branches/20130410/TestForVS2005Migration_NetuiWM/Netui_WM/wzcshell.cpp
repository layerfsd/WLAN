...
void SHWZCValidateSettings(PSHWZCNET pwzcnet)
{
    ...
    static const int SHWZCF_UI_AUTOKEY_FORCE = SHWZCF_UI_AUTOKEY_DISABLED | SHWZCF_UI_AUTOKEY_SET;
...
HRESULT GetWiFiStatusStringFromFlags(DWORD dwWiFiFlags, DWORD dwDisplayFlags, LPTSTR pszStatus, DWORD cchStatus)
{
    ...
    static const int k_cchSsidDisplayMax = 33;
    ...
    if (dwWiFiFlags & WSF_HARDWARE_PRESENT)
    {
        ...
        else
        {
			...
			//LoadString(HINST_RESDLL, IDS_OFF, pszWiFiStatus, k_cchSsidDisplayMax);
        }
