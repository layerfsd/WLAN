...
HRESULT WINAPI ScriptTextOut(
    ...
    __in_ecount(cGlyphs) const int              *piJustify,  // In     Justified advance widths (optional)
...
HRESULT WINAPI ScriptStringAnalyse(
    ...
    __in_ecount(cString) const void              *pString,   //In  String in 8 or 16 bit characters
