...
typedef struct WlanConfig               // Station Configuration Structure for Reading values from Registry.
{
	...
	A_UINT8		DisconnectIfNoDataPkt;	// Force Disconnect If receive no data packet
	A_UINT32	DisconnectIfNoDataPktCheckIntv;	// Interval of force Disconnect If receive no data packet 
