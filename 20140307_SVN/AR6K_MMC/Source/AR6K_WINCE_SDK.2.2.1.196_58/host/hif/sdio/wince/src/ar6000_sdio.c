...
#ifdef MMC_PATCH_REMOVE_ATHSRVC
extern BOOL     bIsNdisRegistered;

DWORD
NdisRegisterAdapterThread2(PVOID Context)
{
	NDIS_STATUS   ndisStatus;

 	if( bIsNdisRegistered ) 
		{
        NdisDeregisterAdapter(&ndisStatus, _T("AR6K_SD1"));
        Sleep(100);
    }

//Sleep(1000);//buildertest: bb for fisrt assoc fail
	...
	if (ndisStatus == NDIS_STATUS_SUCCESS)
		...
		{
		RETAILMSG(1, (TEXT("builder:ar6k2:NdisRegisterAdapter Failed : 0x%x\n\r\n") , ndisStatus));
	}	

    //RETAILMSG(1, (TEXT("NdisRegisterAdapterThread2 .. end thread\r\n")));
	return ndisStatus;
}
#endif
...
DWORD WINAPI DRG_Init(DWORD dwContext)
{
	...
	RETAILMSG( 1, (TEXT(" hongdddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd  SDIO builder:ar6k2:DRG_Init() start\r\n")) );
...
#ifdef MMC_PATCH_REMOVE_ATHSRVC
	{
		hThread = CreateThread(NULL, 0,	NdisRegisterAdapterThread2, NULL, 0, NULL);
