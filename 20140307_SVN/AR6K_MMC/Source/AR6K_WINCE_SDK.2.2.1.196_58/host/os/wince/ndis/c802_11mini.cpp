...
//
{
	...
	ULONG	querydebug = m_Config.dbgQueryOid;
//builderd
if(	 m_Config.suspending )
    ...
    switch (Oid)
    {
        ...
        //
        case OID_802_11_BSSID:
		RETAIL_DEBUG_PRINTF(querydebug, (TEXT("builder:ar6k2:query OID_802_11_BSSID\r\n")));
        ...
        case OID_802_11_SSID:
		RETAIL_DEBUG_PRINTF(querydebug, (TEXT("builder:ar6k2:query OID_802_11_SSID\r\n")));
        ...
        case OID_802_11_NETWORK_TYPES_SUPPORTED:
		RETAIL_DEBUG_PRINTF(querydebug, (TEXT("builder:ar6k2:query OID_802_11_NETWORK_TYPES_SUPPORTED\r\n")));
        ...
        case OID_802_11_NETWORK_TYPE_IN_USE:
		RETAIL_DEBUG_PRINTF(querydebug, (TEXT("builder:ar6k2:query OID_802_11_NETWORK_TYPE_IN_USE\r\n")));
        ...
        case OID_802_11_TX_POWER_LEVEL:
		RETAIL_DEBUG_PRINTF(querydebug, (TEXT("builder:ar6k2:query OID_802_11_TX_POWER_LEVEL\r\n")));
        ...
        case OID_802_11_RSSI:
		RETAIL_DEBUG_PRINTF(querydebug, (TEXT("builder:ar6k2:query OID_802_11_RSSI\r\n")));
        ...
        case OID_802_11_RSSI_TRIGGER:
		RETAIL_DEBUG_PRINTF(querydebug, (TEXT("builder:ar6k2:query OID_802_11_RSSI_TRIGGER\r\n")));
        ...
        case OID_802_11_INFRASTRUCTURE_MODE:
		RETAIL_DEBUG_PRINTF(querydebug, (TEXT("builder:ar6k2:query OID_802_11_INFRASTRUCTURE_MODE\r\n")));
            Get802_11InfrastructureMode((PNDIS_802_11_NETWORK_INFRASTRUCTURE)Buffer);
            break;

        case OID_802_11_FRAGMENTATION_THRESHOLD:
		RETAIL_DEBUG_PRINTF(querydebug, (TEXT("builder:ar6k2:query OID_802_11_FRAGMENTATION_THRESHOLD\r\n")));
        ...
        case OID_802_11_RTS_THRESHOLD:
		RETAIL_DEBUG_PRINTF(querydebug, (TEXT("builder:ar6k2:query OID_802_11_RTS_THRESHOLD\r\n")));
        ...
        case OID_802_11_NUMBER_OF_ANTENNAS:
		RETAIL_DEBUG_PRINTF(querydebug, (TEXT("builder:ar6k2:query OID_802_11_NUMBER_OF_ANTENNAS\r\n")));
        ...
        case OID_802_11_RX_ANTENNA_SELECTED:
		RETAIL_DEBUG_PRINTF(querydebug, (TEXT("builder:ar6k2:query OID_802_11_RX_ANTENNA_SELECTED\r\n")));
            // When queried, this OID requests that the miniport driver return the
        ...
        case OID_802_11_TX_ANTENNA_SELECTED:
		RETAIL_DEBUG_PRINTF(querydebug, (TEXT("builder:ar6k2:query OID_802_11_TX_ANTENNA_SELECTED\r\n")));
            // When queried, this OID requests that the miniport driver return the
        ...
        case OID_802_11_SUPPORTED_RATES:
		RETAIL_DEBUG_PRINTF(querydebug, (TEXT("builder:ar6k2:query OID_802_11_SUPPORTED_RATES\r\n")));
        ...
        case OID_802_11_AUTHENTICATION_MODE:
		RETAIL_DEBUG_PRINTF(querydebug, (TEXT("builder:ar6k2:query OID_802_11_AUTHENTICATION_MODE\r\n")));
            // Return the IEEE 802.11 Authentication Mode
            Get802_11AuthenticationMode((NDIS_802_11_AUTHENTICATION_MODE *)Buffer);
            break;

        case OID_802_11_PRIVACY_FILTER:
		RETAIL_DEBUG_PRINTF(querydebug, (TEXT("builder:ar6k2:query OID_802_11_PRIVACY_FILTER\r\n")));
            // Return the IEEE 802.1X privacy filter mode
            Status = Get802_11PrivacyFilter((PNDIS_802_11_PRIVACY_FILTER)Buffer);
            break;

        case OID_802_11_ENCRYPTION_STATUS:
		RETAIL_DEBUG_PRINTF(querydebug, (TEXT("builder:ar6k2:query OID_802_11_ENCRYPTION_STATUS\r\n")));
        ...
        case OID_802_11_ASSOCIATION_INFORMATION:
		RETAIL_DEBUG_PRINTF(querydebug, (TEXT("builder:ar6k2:query OID_802_11_ASSOCIATION_INFORMATION\r\n")));
...
#ifdef SUPPORT_WPA2
        case OID_802_11_PMKID:
		RETAIL_DEBUG_PRINTF(querydebug, (TEXT("builder:ar6k2:query OID_802_11_PMKID\r\n")));
            Status = Get802_11PMKID((NDIS_802_11_PMKID *)Buffer, cbBuffer, pcbNeeded);
            break;

        case OID_802_11_CAPABILITY:
		RETAIL_DEBUG_PRINTF(querydebug, (TEXT("builder:ar6k2:query OID_802_11_CAPABILITY\r\n")));
		...
		RETAIL_DEBUG_PRINTF(querydebug, (TEXT("builder:ar6k2:query OID_802_11_NIC_ROAM_CONTROL\r\n")));
            Status = Get802_11RoamControl((PNDIS_802_11_NIC_ROAM_CONTROL)Buffer);
            break;

        case OID_802_11_CHANNEL_LIST:
		RETAIL_DEBUG_PRINTF(querydebug, (TEXT("builder:ar6k2:query OID_802_11_CHANNEL_LIST\r\n")));
            Status = Get802_11ChannelList((PNDIS_802_11_CHANNEL_LIST)Buffer, cbBuffer, pcbNeeded);
            break;

        case OID_802_11_BSSID_RATE_RSSI_FILTER:
		RETAIL_DEBUG_PRINTF(querydebug, (TEXT("builder:ar6k2:query OID_802_11_BSSID_RATE_RSSI_FILTER\r\n")));
            Status = Get802_11RateRssiFilter((PNDIS_802_11_BSSID_RATE_RSSI_FILTER)Buffer);
            break;

        case OID_802_11_BSSID_RATE_RSSI_INFO:
		RETAIL_DEBUG_PRINTF(querydebug, (TEXT("builder:ar6k2:query OID_802_11_BSSID_RATE_RSSI_INFO\r\n")));
...
{
    NDIS_STATUS                 Status = NDIS_STATUS_SUCCESS;
	ULONG	setdebug = m_Config.dbgSetOid;
...
if(	 m_Config.suspending )
    ...
    switch (Oid)
    {
        ...
        //
        case OID_802_11_BSSID:
		RETAIL_DEBUG_PRINTF(setdebug, (TEXT("builder:ar6k2:set OID_802_11_BSSID\r\n")));
            Status = Set802_11AssociatedAPBSSID((NDIS_802_11_MAC_ADDRESS *)Buffer);
            break;

        case OID_802_11_SSID:
		RETAIL_DEBUG_PRINTF(setdebug, (TEXT("builder:ar6k2:set OID_802_11_SSID\r\n")));
        ...
        case OID_802_11_NETWORK_TYPE_IN_USE:
		RETAIL_DEBUG_PRINTF(setdebug, (TEXT("builder:ar6k2:set OID_802_11_NETWORK_TYPE_IN_USE\r\n")));
            Status = Set802_11NetworkTypeInUse(*(NDIS_802_11_NETWORK_TYPE *)Buffer);
            break;

        case OID_802_11_TX_POWER_LEVEL:
		RETAIL_DEBUG_PRINTF(setdebug, (TEXT("builder:ar6k2:set OID_802_11_TX_POWER_LEVEL\r\n")));
            Status = Set802_11TxPowerLevel(*(NDIS_802_11_TX_POWER_LEVEL *)Buffer);
            break;

        case OID_802_11_RSSI_TRIGGER:
		RETAIL_DEBUG_PRINTF(setdebug, (TEXT("builder:ar6k2:set OID_802_11_RSSI_TRIGGER\r\n")));
            Status = Set802_11RSSITrigger(*(NDIS_802_11_RSSI *)Buffer);
            break;

        case OID_802_11_INFRASTRUCTURE_MODE:
		RETAIL_DEBUG_PRINTF(setdebug, (TEXT("builder:ar6k2:set OID_802_11_INFRASTRUCTURE_MODE\r\n")));
            Status = Set802_11InfrastructureMode(*(NDIS_802_11_NETWORK_INFRASTRUCTURE *)Buffer);
            break;

        case OID_802_11_FRAGMENTATION_THRESHOLD:
		RETAIL_DEBUG_PRINTF(setdebug, (TEXT("builder:ar6k2:set OID_802_11_FRAGMENTATION_THRESHOLD\r\n")));
            Status = Set802_11FragmentationThreshold(*(NDIS_802_11_FRAGMENTATION_THRESHOLD *)Buffer);
            break;

        case OID_802_11_RTS_THRESHOLD:
		RETAIL_DEBUG_PRINTF(setdebug, (TEXT("builder:ar6k2:set OID_802_11_RTS_THRESHOLD\r\n")));
            Status = Set802_11RTSThreshold(*(NDIS_802_11_RTS_THRESHOLD *)Buffer);
            break;

        case OID_802_11_RX_ANTENNA_SELECTED:
		RETAIL_DEBUG_PRINTF(setdebug, (TEXT("builder:ar6k2:set OID_802_11_RX_ANTENNA_SELECTED\r\n")));
            Status = Set802_11RxAntennaSelected(*(ULONG *)Buffer);
            break;

        case OID_802_11_TX_ANTENNA_SELECTED:
		RETAIL_DEBUG_PRINTF(setdebug, (TEXT("builder:ar6k2:set OID_802_11_TX_ANTENNA_SELECTED\r\n")));
            Status = Set802_11TxAntennaSelected(*(ULONG *)Buffer);
            break;

        case OID_802_11_DESIRED_RATES:
		RETAIL_DEBUG_PRINTF(setdebug, (TEXT("builder:ar6k2:set OID_802_11_DESIRED_RATES\r\n")));
            Status = Set802_11DesiredRates((NDIS_802_11_RATES *)Buffer);
            break;

        case OID_802_11_CONFIGURATION:
		RETAIL_DEBUG_PRINTF(setdebug, (TEXT("builder:ar6k2:set OID_802_11_CONFIGURATION\r\n")));
            Status = Set802_11Configuration((NDIS_802_11_CONFIGURATION *)Buffer);
            break;

        case OID_802_11_DISASSOCIATE:
		RETAIL_DEBUG_PRINTF(setdebug, (TEXT("builder:ar6k2:set OID_802_11_DISASSOCIATE\r\n")));
        ...
        case OID_802_11_POWER_MODE:
		RETAIL_DEBUG_PRINTF(setdebug, (TEXT("builder:ar6k2:set OID_802_11_POWER_MODE\r\n")));
            Status = Set802_11PowerMode(*(NDIS_802_11_POWER_MODE *)Buffer);
            break;

        case OID_802_11_BSSID_LIST_SCAN:
		RETAIL_DEBUG_PRINTF(setdebug, (TEXT("builder:ar6k2:set OID_802_11_BSSID_LIST_SCAN\r\n")));
            Status = Set802_11BSSIDListScan();
            break;

        case OID_802_11_PRIVACY_FILTER:
		RETAIL_DEBUG_PRINTF(setdebug, (TEXT("builder:ar6k2:set OID_802_11_PRIVACY_FILTER\r\n")));
            Status = Set802_11PrivacyFilter(*(NDIS_802_11_PRIVACY_FILTER *)Buffer);
            break;

        case OID_802_11_RELOAD_DEFAULTS:
		RETAIL_DEBUG_PRINTF(setdebug, (TEXT("builder:ar6k2:set OID_802_11_RELOAD_DEFAULTS\r\n")));
            Status = Set802_11ReloadDefaults(*(NDIS_802_11_RELOAD_DEFAULTS *)Buffer);
            break;

        case OID_802_11_AUTHENTICATION_MODE:
		RETAIL_DEBUG_PRINTF(setdebug, (TEXT("builder:ar6k2:set OID_802_11_AUTHENTICATION_MODE\r\n")));
            Status = Set802_11AuthenticationMode(*(NDIS_802_11_AUTHENTICATION_MODE *)Buffer);
            break;

        case OID_802_11_ENCRYPTION_STATUS:
		RETAIL_DEBUG_PRINTF(setdebug, (TEXT("builder:ar6k2:set OID_802_11_ENCRYPTION_STATUS\r\n")));
            Status = Set802_11EncryptionStatus(*(NDIS_802_11_ENCRYPTION_STATUS *)Buffer);
            break;

        case OID_802_11_ADD_WEP:
		RETAIL_DEBUG_PRINTF(setdebug, (TEXT("builder:ar6k2:set OID_802_11_ADD_WEP\r\n")));
            Status = Set802_11AddWEP((NDIS_802_11_WEP *)Buffer);
            break;

        case OID_802_11_REMOVE_WEP:
		RETAIL_DEBUG_PRINTF(setdebug, (TEXT("builder:ar6k2:set OID_802_11_REMOVE_WEP\r\n")));
            Status = Set802_11RemoveWEP(*(NDIS_802_11_KEY_INDEX *)Buffer);
            break;

        case OID_802_11_ADD_KEY:
		RETAIL_DEBUG_PRINTF(setdebug, (TEXT("builder:ar6k2:set OID_802_11_ADD_KEY\r\n")));
            Status = Set802_11AddKey((NDIS_802_11_KEY *)Buffer, FALSE);
            break;

        case OID_802_11_REMOVE_KEY:
		RETAIL_DEBUG_PRINTF(setdebug, (TEXT("builder:ar6k2:set OID_802_11_REMOVE_KEY\r\n")));
            Status = Set802_11RemoveKey((NDIS_802_11_REMOVE_KEY *)Buffer);
            break;

        case OID_802_11_ASSOCIATION_INFORMATION:
		RETAIL_DEBUG_PRINTF(setdebug, (TEXT("builder:ar6k2:set OID_802_11_ASSOCIATION_INFORMATION\r\n")));
            Status = Set802_11AssociationInformation((NDIS_802_11_ASSOCIATION_INFORMATION *)Buffer, cbBuffer);
            break;

#ifdef SUPPORT_WPA2
        case OID_802_11_PMKID:
		RETAIL_DEBUG_PRINTF(setdebug, (TEXT("builder:ar6k2:set OID_802_11_PMKID\r\n")));
            Status = Set802_11PMKID((NDIS_802_11_PMKID*)Buffer, cbBuffer);
            break;
#endif

        case OID_802_11_TEST:
		RETAIL_DEBUG_PRINTF(setdebug, (TEXT("builder:ar6k2:set OID_802_11_TEST\r\n")));
            Status = Set802_11Test((NDIS_802_11_TEST *)Buffer,cbBuffer);
            break;

#ifdef OS_ROAM_MANAGEMENT
        case OID_802_11_NIC_ROAM_CONTROL:
		RETAIL_DEBUG_PRINTF(setdebug, (TEXT("builder:ar6k2:set OID_802_11_NIC_ROAM_CONTROL\r\n")));
            Status = Set802_11RoamControl((PNDIS_802_11_NIC_ROAM_CONTROL)Buffer);
            break;

        case OID_802_11_BSSID_CHANNEL_SCAN:
		RETAIL_DEBUG_PRINTF(setdebug, (TEXT("builder:ar6k2:set OID_802_11_BSSID_CHANNEL_SCAN\r\n")));
            Status = Set802_11ChannelScan((PNDIS_802_11_BSSID_CHANNEL_SCAN)Buffer);
            break;

        case OID_802_11_BSSID_RATE_RSSI_FILTER:
		RETAIL_DEBUG_PRINTF(setdebug, (TEXT("builder:ar6k2:set OID_802_11_BSSID_RATE_RSSI_FILTER\r\n")));
