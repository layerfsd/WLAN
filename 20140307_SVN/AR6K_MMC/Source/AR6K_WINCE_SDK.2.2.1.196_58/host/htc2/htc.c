...
A_STATUS    PreHTCStart(HTC_HANDLE HTCHandle)
{
	HTC_TARGET *target = GET_HTC_TARGET_FROM_HANDLE(HTCHandle);
...
A_STATUS HTCStart(HTC_HANDLE HTCHandle)
{
    ...
    //--buildertest DevDisableInterrupts(&target->Device);
    DevMaskInterrupts(&target->Device); //+buildertest
...
//RETAILMSG(1, (TEXT("builder:ar6k2:HTCStop() start>>\r\n")));

#if  1
    LOCK_HTC_RX(target);
//RETAILMSG(1, (TEXT("builder:ar6k2:HTCStop() 0.0\r\n")));
        /* mark that we are shutting down .. */
    target->HTCStateFlags |= HTC_STATE_STOPPING;
    UNLOCK_HTC_RX(target);
//RETAILMSG(1, (TEXT("builder:ar6k2:HTCStop() 0.1\r\n")));	
#else
    target->HTCStateFlags |= HTC_STATE_STOPPING;
#endif
...
//RETAILMSG(1, (TEXT("builder:ar6k2:HTCStop() 0.2\r\n")));
        /* flush all send packets */
    HTCFlushSendPkts(target);
//RETAILMSG(1, (TEXT("builder:ar6k2:HTCStop() 1\r\n")));		
        /* flush all recv buffers */
    HTCFlushRecvBuffers(target);
//RETAILMSG(1, (TEXT("builder:ar6k2:HTCStop() 2\r\n")));		
//UNLOCK_HTC(target);
//RETAILMSG(1, (TEXT("builder:ar6k2:HTCStop() 3\r\n")));		
    ResetEndpointStates(target);
//RETAILMSG(1, (TEXT("builder:ar6k2:HTCStop() <<end\r\n")));
