...
struct ieee80211_node_table {
    ...
    A_TIMER                 nt_inact_timer;  //+builder:nodeage
    A_UINT8                 isTimerArmed;   /* is the node timer armed */  //+builder:nodeage
...
#define WLAN_NODE_INACT_TIMEOUT_MSEC            30000 //builder org=120000
