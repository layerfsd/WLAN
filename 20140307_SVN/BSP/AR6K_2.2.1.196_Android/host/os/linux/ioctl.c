...
/* ATHENV */
    ...
    ar->arPhyCapability = cmdp->phyMode;	/* set the radio phy mode accordingly - bug 82603 */
...
/*                HTCForceReset(htcTarget); */
        ...
        case AR6000_XIOCTL_WMI_STARTSCAN:
        {
			...
			printk(" AR6000_XIOCTL_WMI_STARTSCAN !!!! ar->arWmiReady = %d \r\n",ar->arWmiReady);
            if (ar->arWmiReady == FALSE) 
			{
                   ret = -EIO;
            } 
        ...
        case AR6000_XIOCTL_WMI_SET_MGMT_FRM_RX_FILTER:
        {
			...
			printk(" ###### AR6000_XIOCTL_WMI_SET_MGMT_FRM_RX_FILTER, bssFilter = %d \r\n", cmd.bssFilter);
