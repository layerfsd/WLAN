...
extern char *strerror(int status);
...
cmd_t dhd_cmds[] = {
	...
	{ "rxflowmode", dhd_varint, DHD_GET_VAR, DHD_SET_VAR,
	"get/set dhd rx flow control enable flag"},
	{ "rxflowhi", dhd_varint, DHD_GET_VAR, DHD_SET_VAR,
	"get/set dhd rx flow control high water mark"},
	{ "rxflowlow", dhd_varint, DHD_GET_VAR, DHD_SET_VAR,
	"get/set dhd rx flow control low water mark"},
