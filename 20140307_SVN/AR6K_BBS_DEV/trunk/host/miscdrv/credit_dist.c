                               ...
                               int                      TotalCredits)
{
    ...
    if (pCredInfo->CurrentFreeCredits <= 0) {
        NDIS_DEBUG_PRINTF(DBG_TRACE, "Not enough credits (%d) to do credit distributions \n", TotalCredits);
        //A_ASSERT(FALSE);
                                     ...
                                     HTC_CREDIT_DIST_REASON   Reason)
{
    ...
    switch (Reason) {
        ...
        case HTC_DUMP_CREDIT_STATE :
            NDIS_DEBUG_PRINTF(DBG_TRACE, "Credit Distribution, total : %d, free : %d\n",
	...
	AR_DEBUG_ASSERT(pCredInfo->CurrentFreeCredits <= pCredInfo->TotalAvailableCredits);
	AR_DEBUG_ASSERT(pCredInfo->CurrentFreeCredits >= 0);
