...
#define _P	L"\r[AR6K: C802_Mini] "L
...
//
{
	...
	switch (Oid)
	{
		...
		case OID_802_11_SSID:
			...
			NDIS_DEBUG_PRINTF(DBG_QUERY_OID, "NDIS Query -> OID_802_11_SSID \r\n");
		...
		case OID_802_11_RSSI:
			...
			NDIS_DEBUG_PRINTF(DBG_QUERY_OID, "NDIS Query -> OID_802_11_RSSI \r\n");
		...
		case OID_802_11_BSSID_LIST:
			...
			NDIS_DEBUG_PRINTF(DBG_QUERY_OID, "NDIS Query -> OID_802_11_BSSID_LIST \r\n");
	...
	NDIS_DEBUG_PRINTF(DBG_TRACE,"AR6K: Query Status=%x for %hs\r\n", Status, szBuffer);
#endif
	...
	OUT PULONG   pcbNeeded)
{
	...
	switch (Oid)
	{
		...
		//
		case OID_802_11_BSSID:
			NDIS_DEBUG_PRINTF(DBG_SET_OID, "NDIS Set -> OID_802_11_BSSID \r\n");
			Status = Set802_11AssociatedAPBSSID((NDIS_802_11_MAC_ADDRESS *)Buffer);
			break;

		case OID_802_11_SSID:
			NDIS_DEBUG_PRINTF(DBG_SET_OID, " Set -> OID_802_11_SSID \r\n");
			Status = Set802_11SSID((NDIS_802_11_SSID *)Buffer);
			break;

		case OID_802_11_NETWORK_TYPE_IN_USE:
			NDIS_DEBUG_PRINTF(DBG_SET_OID, " Set -> OID_802_11_NETWORK_TYPE_IN_USE \r\n");
			Status = Set802_11NetworkTypeInUse(*(NDIS_802_11_NETWORK_TYPE *)Buffer);
			break;

		case OID_802_11_TX_POWER_LEVEL:
			NDIS_DEBUG_PRINTF(DBG_SET_OID, " Set -> OID_802_11_TX_POWER_LEVEL \r\n");
			Status = Set802_11TxPowerLevel(*(NDIS_802_11_TX_POWER_LEVEL *)Buffer);
			break;

		case OID_802_11_RSSI_TRIGGER:
			NDIS_DEBUG_PRINTF(DBG_SET_OID," Set -> OID_802_11_RSSI_TRIGGER \r\n");
			Status = Set802_11RSSITrigger(*(NDIS_802_11_RSSI *)Buffer);
			break;

		case OID_802_11_INFRASTRUCTURE_MODE:
			NDIS_DEBUG_PRINTF(DBG_SET_OID," Set -> OID_802_11_INFRASTRUCTURE_MODE \r\n");
			Status = Set802_11InfrastructureMode(*(NDIS_802_11_NETWORK_INFRASTRUCTURE *)Buffer);
			break;

		case OID_802_11_FRAGMENTATION_THRESHOLD:
			NDIS_DEBUG_PRINTF(DBG_SET_OID, " Set -> OID_802_11_FRAGMENTATION_THRESHOLD \r\n");
			Status = Set802_11FragmentationThreshold(*(NDIS_802_11_FRAGMENTATION_THRESHOLD *)Buffer);
			break;

		case OID_802_11_RTS_THRESHOLD:
			NDIS_DEBUG_PRINTF(DBG_SET_OID, " Set -> OID_802_11_RTS_THRESHOLD \r\n");
			Status = Set802_11RTSThreshold(*(NDIS_802_11_RTS_THRESHOLD *)Buffer);
			break;

		case OID_802_11_RX_ANTENNA_SELECTED:
			NDIS_DEBUG_PRINTF(DBG_SET_OID, " Set -> OID_802_11_RX_ANTENNA_SELECTED \r\n");
			Status = Set802_11RxAntennaSelected(*(ULONG *)Buffer);
			break;

		case OID_802_11_TX_ANTENNA_SELECTED:
			NDIS_DEBUG_PRINTF(DBG_SET_OID, " Set -> OID_802_11_TX_ANTENNA_SELECTED \r\n");
			Status = Set802_11TxAntennaSelected(*(ULONG *)Buffer);
			break;

		case OID_802_11_DESIRED_RATES:
			NDIS_DEBUG_PRINTF(DBG_SET_OID, " Set -> OID_802_11_DESIRED_RATES \r\n");
			Status = Set802_11DesiredRates((NDIS_802_11_RATES *)Buffer);
			break;

		case OID_802_11_CONFIGURATION:
			NDIS_DEBUG_PRINTF(DBG_SET_OID, " Set -> OID_802_11_CONFIGURATION \r\n");
			Status = Set802_11Configuration((NDIS_802_11_CONFIGURATION *)Buffer);
			break;

		case OID_802_11_DISASSOCIATE:
			NDIS_DEBUG_PRINTF(DBG_SET_OID, " Set -> OID_802_11_DISASSOCIATE \r\n");
			Status = Set802_11Disassociate();
			break;

		case OID_802_11_POWER_MODE:
			NDIS_DEBUG_PRINTF(DBG_SET_OID, " Set -> OID_802_11_POWER_MODE \r\n");
			Status = Set802_11PowerMode(*(NDIS_802_11_POWER_MODE *)Buffer);
			break;

		case OID_802_11_BSSID_LIST_SCAN:
			NDIS_DEBUG_PRINTF(DBG_SET_OID, " Set -> OID_802_11_BSSID_LIST_SCAN \r\n");
			Status = Set802_11BSSIDListScan();
			break;

		case OID_802_11_PRIVACY_FILTER:
			NDIS_DEBUG_PRINTF(DBG_SET_OID, " Set -> OID_802_11_PRIVACY_FILTER \r\n");
			Status = Set802_11PrivacyFilter(*(NDIS_802_11_PRIVACY_FILTER *)Buffer);
			break;

		case OID_802_11_RELOAD_DEFAULTS:
			NDIS_DEBUG_PRINTF(DBG_SET_OID, " Set -> OID_802_11_RELOAD_DEFAULTS \r\n");
			Status = Set802_11ReloadDefaults(*(NDIS_802_11_RELOAD_DEFAULTS *)Buffer);
			break;

		case OID_802_11_AUTHENTICATION_MODE:
			NDIS_DEBUG_PRINTF(DBG_SET_OID, " Set -> OID_802_11_AUTHENTICATION_MODE \r\n");
			Status = Set802_11AuthenticationMode(*(NDIS_802_11_AUTHENTICATION_MODE *)Buffer);
			break;

		case OID_802_11_ENCRYPTION_STATUS:
			NDIS_DEBUG_PRINTF(DBG_SET_OID, " Set -> OID_802_11_ENCRYPTION_STATUS \r\n");
			Status = Set802_11EncryptionStatus(*(NDIS_802_11_ENCRYPTION_STATUS *)Buffer);
			break;

		case OID_802_11_ADD_WEP:
			NDIS_DEBUG_PRINTF(DBG_SET_OID, " Set -> OID_802_11_ADD_WEP \r\n");
			Status = Set802_11AddWEP((NDIS_802_11_WEP *)Buffer);
			break;

		case OID_802_11_REMOVE_WEP:
			NDIS_DEBUG_PRINTF(DBG_SET_OID, " Set -> OID_802_11_REMOVE_WEP \r\n");
			Status = Set802_11RemoveWEP(*(NDIS_802_11_KEY_INDEX *)Buffer);
			break;

		case OID_802_11_ADD_KEY:
			NDIS_DEBUG_PRINTF(DBG_SET_OID," Set -> OID_802_11_ADD_KEY \r\n");
			Status = Set802_11AddKey((NDIS_802_11_KEY *)Buffer);
			break;

		case OID_802_11_REMOVE_KEY:
			NDIS_DEBUG_PRINTF(DBG_SET_OID, " Set -> OID_802_11_REMOVE_KEY \r\n");
			Status = Set802_11RemoveKey((NDIS_802_11_REMOVE_KEY *)Buffer);
			break;

		case OID_802_11_ASSOCIATION_INFORMATION:
			NDIS_DEBUG_PRINTF(DBG_SET_OID, " Set -> OID_802_11_ASSOCIATION_INFORMATION \r\n");
			Status = Set802_11AssociationInformation((NDIS_802_11_ASSOCIATION_INFORMATION *)Buffer, cbBuffer);
			break;

#ifdef SUPPORT_WPA2
		case OID_802_11_PMKID:
			NDIS_DEBUG_PRINTF(DBG_SET_OID, " Set :: OID_802_11_PMKID \r\n");
			Status = Set802_11PMKID((NDIS_802_11_PMKID*)Buffer, cbBuffer);
			break;
#endif

		case OID_802_11_TEST:
			NDIS_DEBUG_PRINTF(DBG_SET_OID, " Set :: OID_802_11_TEST \r\n");
	...
	Get80211OidTypeAndData(szBuffer, Oid, (PBYTE)Buffer);
	NDIS_DEBUG_PRINTF(DBG_TRACE, "AR6K: Set Status=%x for %hs\r\n", Status, szBuffer);
#endif
