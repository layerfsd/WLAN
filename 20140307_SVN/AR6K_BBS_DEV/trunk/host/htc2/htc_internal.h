...
#define HTC_TARGET_RESPONSE_TIMEOUT        4000 /* in ms */
...
//bluebird 
extern __inline void HTC_RECYCLE_RX_PKT(HTC_TARGET *target, HTC_PACKET *p, HTC_ENDPOINT *e);
...
static __inline HTC_PACKET *HTC_ALLOC_CONTROL_TX(HTC_TARGET *target) {
