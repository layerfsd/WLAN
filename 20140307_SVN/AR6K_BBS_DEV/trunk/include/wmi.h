...
typedef enum {
    ...
    ENABLE_AUTO_CTRL_FLAGS = 0x20,      /* if disabled, target doesn't  scan after a disconnect event  */
...
#define NO_ROAM_SCAN_CTRL_FLAGS         (CONNECT_SCAN_CTRL_FLAGS| SCAN_CONNECTED_CTRL_FLAGS| ACTIVE_SCAN_CTRL_FLAGS | ENABLE_AUTO_CTRL_FLAGS)
...
typedef enum {
    ...
    WMI_11B_CAPABILITY   = 4,		    /* Bug 82603 */
    WMI_11GONLY_CAPABILITY = 5
} WMI_PHY_CAPABILITY;
