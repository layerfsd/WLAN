 ...
 *
 * $Id: wlu_pipe.c,v 1.1.6.5.2.5 2010/01/04 23:57:23 Exp $
 */
#ifdef WIN32
...
rwl_wifi_allocate_actionframe()
{
	...
	action_frame->OUI[0] 	= RWL_WIFI_OUI_BYTE1;
	action_frame->OUI[1] 	= RWL_WIFI_OUI_BYTE2;
	action_frame->OUI[2] 	= RWL_WIFI_OUI_BYTE3;
