...
/* the following is a made-up mode to satisfy a customer requirement */
#define DOT11_OPEN_SHARED	2	/* try open first, then shared if open failed with rc 13 */
...
#define DOT11_ACTION_CAT_VS			127	/* d11 action category vendor Specific */
