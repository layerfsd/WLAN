 ...
 *
 * $Id: wlm.h,v 1.3.2.2.2.13 2010/04/27 00:09:16 Exp $
 */
...
/* Band range to set/retrieve PA parameters */
enum {
	WLM_NPHY_2G_CHAIN0 = 0,
	WLM_NPHY_2G_CHAIN1,
	WLM_NPHY_5GL_CHAIN0,
	WLM_NPHY_5GL_CHAIN1,
	WLM_NPHY_5GM_CHAIN0,
...
/* Sets the operating rate of the DUT.
 *
...
/* Retrieves the power amplifier parameters.
 *
 * bandrange The desired band range for getting PA parameters.
 * param[in] b0 PA parameter returned.
 * param[in] b1 PA parameter returned.
 * param[in] a1 PA parameter returned.
 *
 * return - True for success, false for failure.
 */
WLM_FUNCTION
...
/* Sets the power amplifier parameters.
 *
 * bandrange The desired band range for getting PA parameters.
 ...
 * param[in] band Desired band. Ignored if <i>enable</i> is false.
 *
 * return - True for success, false for failure.
 */
WLM_FUNCTION
